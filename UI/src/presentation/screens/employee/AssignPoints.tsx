...
import { User, Category } from '@/infrastructure/interfaces';
import { getUsers } from '@/actions/users/user.actions';
import { getMyAllocation } from '@/actions/allocations/allocation.actions';
import { createAssignment } from '@/actions/assignments/assignment.actions';
...
import { Gift, Search, X, CheckCircle2, AlertCircle, Info, User as UserIcon, Building2, ShieldCheck, ArrowLeft } from '@/config/adapters/icons.adapter';
import { showSuccess, showError } from '@/config/adapters/toast.adapter';
