...
import { User, MonthlyAllocation, PointAssignment } from '@/infrastructure/interfaces';
import { getMyAllocation } from '@/actions/allocations/allocation.actions';
import { getReceivedAssignments } from '@/actions/assignments/assignment.actions';
...
import { Award, Gift, TrendingUp, Calendar, LogOut, Info, Sparkles, Clock, User as UserIcon } from '@/config/adapters/icons.adapter';
import { AssignPoints } from '@/presentation/screens/employee/AssignPoints';
import { Onboarding } from '@/presentation/screens/employee/Onboarding';
...
import { motion, AnimatePresence } from '@/config/adapters/animation.adapter';
