...
import { User, PointAssignment } from '@/infrastructure/interfaces';
import { getUsers } from '@/actions/users/user.actions';
import { getAllAssignments } from '@/actions/assignments/assignment.actions';
import { getMyAllocation } from '@/actions/allocations/allocation.actions';
import { getCurrentMonth } from '@/infrastructure/helpers/date';
...
import { Award, Users, TrendingUp, Download, LogOut, BarChart3, Search, Filter, Mail, FileText, ChevronDown, ChevronUp } from '@/config/adapters/icons.adapter';
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip as ChartTooltip, PieChart, Pie, Cell, ResponsiveContainer } from '@/config/adapters/chart.adapter';
import { DashboardSkeleton } from '@/presentation/components/shared/SkeletonLoader';
import { motion } from '@/config/adapters/animation.adapter';
import { showSuccess } from '@/config/adapters/toast.adapter';
...
export function PeopleDashboard({ user, onLogout }: PeopleDashboardProps) {
  ...
  const exportDetailedReport = () => {
    ...
    showSuccess('Reporte detallado exportado', {
